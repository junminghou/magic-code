...
public class FlowTaskDetailBO {
     ...
     * 任务已发放金额
     */
    private String taskMoneySend;
    /**
     * 任务单价
     */
    private String taskUnitPrice;
    /**
     * 任务剩余报名名额
     */
     ...
     * 完成任务的人员数量
     */
    private Integer doneTaskUserCount;
    /**
     * 任务截止时间: 2021-07-01 12:00:00
     */
    ...
    /**
     * 任务状态, 10待审核，20审核通过，30审核不通过，40已完成，50已终止，60已下架,70已结束
     */
    private Integer taskStatus;
    /**
     * 1抖音视频链接，2抖音直播链接，3抖音主页链接，4h5链接
     */
     ...
     * 更多任务
     */
    private List {{ _("FlowMoreTaskDetailBO") }} moreTaskList;
    ...
    /**
     * 已消耗佣金, 预估佣金+已赚佣金+已退佣金
     */
    private String spendTotalCommission;
    /**
     * 有效引流人数, 有效引流：点击任务详情并成功跳转到对应内容页的人数
     */
    private Integer availableFlowUserCount;
